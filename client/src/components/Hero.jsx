    ...
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      <div className='flex-1 flex justify-center items-start flex-col xl:px-0 sm:px-16 px-6'>
        ...
        <div className="flex flex-row justify-between items-center w-full sm:w-[900px]">
            <h1 className='flex-1 font-monse font-bold ss:text-[72px] text-[50px] text-purple ss:leading-[100px] leading-[75px]'>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative sm:mr-[60px]`}>
